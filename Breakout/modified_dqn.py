...
# Modified DQN agent for the use of physics
class ModifiedDQNAgent(AbstractDQNAgent):
    """
    # Arguments
    ...
    def __init__(self, model, policy=None, test_policy=None, enable_double_dqn=True, enable_dueling_network=False,
        ...
        super(ModifiedDQNAgent, self).__init__(*args, **kwargs)
    ...
    def get_config(self):
        config = super(ModifiedDQNAgent, self).get_config()
    ...
    def forward(self, observation):
        ...
        # Book-keeping first for use of the policy.
