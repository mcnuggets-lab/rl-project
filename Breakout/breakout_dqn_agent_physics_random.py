...
policy = EpsilonPhysicsPolicy(eps_phy=0.9, eps_ran=0.1)
...
if args.mode == 'train':
    ...
    weights_filename = 'wts/dqn_{}_weights_phyran.h5f'.format(args.env_name)
    checkpoint_weights_filename = 'wts/dqn_' + args.env_name + '_weights_{step}_phyran.h5f'
    log_filename = 'dqn_{}_log_phyran.json'.format(args.env_name)
    ...
    weights_filename = 'wts/dqn_Breakout-v0_weights_12000000_phyran.h5f'.format(args.env_name)
    if args.weights:
